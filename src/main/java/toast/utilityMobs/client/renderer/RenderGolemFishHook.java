...
public class RenderGolemFishHook extends Render
{
    ...
    public void doRenderSpecialFishHook(EntityGolemFishHook entity, double x, double y, double z, float f, float partialTicks) {
        GL11.glPushMatrix();
    ...
    public void doRender(Entity entity, double x, double y, double z, float yaw, float partialTicks) {
        this.doRenderSpecialFishHook((EntityGolemFishHook)entity, x, y, z, yaw, partialTicks);
    }
}